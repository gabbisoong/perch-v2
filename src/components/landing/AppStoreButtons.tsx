  ...
  return (
    <div className="flex items-center gap-3 md:gap-4 text-white font-semibold leading-none justify-center flex-wrap">
      ...
      >
        ...
        <span className="text-[13px] md:text-[14px]">App Store</span>
      </a>
      <a 
      ...
      >
        ...
        <span className="text-[13px] md:text-[14px]">Google Play</span>
      </a>
    </div>
  );
};
