...
export const Hero = () => {
  ...
  return (
    <section id="hero-section" className="mt-[91px] max-md:mt-[70px]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-[65px] font-semibold leading-none tracking-[-1.3px] max-md:text-[36px]">
            Meet Perch.
          </h1>
          <p className="text-[36px] max-md:text-[30.6px] font-normal leading-[43px] max-md:leading-[37px] tracking-[-0.36px] mt-4 max-w-[450px]">
            The new home for all your blogs and newsletters.
          </p>
          <div className="mt-9">
            <AppStoreButtons />
          </div>
          <div className="mt-16 relative w-full max-w-[1200px] md:block hidden">
          ...
          {/* Mobile Phone Hero */}
          <div className="mt-8 relative w-full max-w-[412px] mx-auto md:hidden block">
            <div className="relative w-full">
              <div className="relative w-full mt-4">
                <img
                  src="/phone-hero-mobile.png"
                  alt="Perch app interface"
                  className="w-full h-auto relative z-20 drop-shadow-2xl"
                />
              {/* Floating cards removed from mobile */}
              {/* All floating cards removed from mobile */}
